...
from users.views import ProfileView, EditProfileView, ChangePassword, CustomPasswordChangeDoneView, CustomPasswordResetView, CustomPasswordResetConfirmView
